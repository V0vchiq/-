...
class ModelService {
  ...
  static const List<AIModel> availableModels = [
    ...
    AIModel(
      ...
      name: 'Llama 3.2 1B',
      size: '1.3 GB',
      description: 'Быстрые ответы на простые вопросы. Может путаться и ошибаться в вопросах среднего и тяжёлого уровня',
    ...
    AIModel(
      ...
      size: '1.3 GB',
      description: 'Простой код: скрипты, функции, базовый синтаксис. Не для сложных проектов',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      name: 'Gemma 2 2B',
      size: '1.9 GB',
      description: 'Тексты, переводы, краткие пересказы, ответы на повседневные вопросы. Хороший баланс скорости и качества',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      name: 'Ministral 3 3B',
      size: '2.1 GB',
      description: 'Анализ текста и деталей, понимание контекста, следование инструкциям',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      size: '2.2 GB',
      description: 'Логические задачи, математика, рассуждения. Обучена на качественных данных',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      name: 'Llama 3.2 3B',
      size: '2.5 GB',
      description: 'Диалоги, советы, объяснения. Универсальный помощник среднего уровня',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      size: '4.0 GB',
      description: 'Профессиональный код: архитектура, отладка, рефакторинг на любых ЯП',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      name: 'Llama 3.1 8B',
      size: '4.9 GB',
      description: 'Сложные вопросы, анализ, творческие задачи. Высокое качество ответов',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      size: '5.0 GB',
      description: 'Лучшая для русского языка. Развёрнутые и грамотные ответы',
      type: ModelType.offline,
    ...
    AIModel(
      ...
      name: 'DeepSeek V3.2',
      size: null,
      description: 'Требуется интернет. Подробные качественные ответы, сложные задачи, проверка фактов',
